    ...
    <div class="container_12">
      <div class="grid_8">
        ...
        <tr style="background-color:bisque" align="center" class="bold">            
             <td class="bold" style="color:black"  >Invoice-No</td><td align="center" class="bold" style="color:black" >Payment</td><td align="center" class="bold" style="color:black" >Payment-Date</td><td align="center" class="bold" style="color:black" >Payment-type</td><td align="center" class="bold" style="color:black" >Room-No</td>
...
$s="select * from invoice";
  ...
  {
        echo"<tr><td  style=' padding-left:50px'>$data[0]</td><td  style=' padding-left:10px'>$data[1]</td><td  style=' padding-left:20px'>$data[2]</td><td  style=' padding-left:30px'>$data[3]</td><td  style=' padding-left:50px'>$data[4]</td></tr>";
      }
      mysqli_close($cn);
?>
