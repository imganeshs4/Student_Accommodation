...
<div class="main">
  ...
  <section id="content">
    <div class="container_12">
      <div class="grid_8">
        <h2 class="top-1 p3">Flat details</h2>
        ...
        <tr style="background-color:bisque" align="left" class="bold">            
             <td class="bold" style="color:black"  >Flat No</td><td align="left" class="bold" style="color:black" >Flat Address</td><td align="left" class="bold" style="color:black" >No. Of  Rooms</td>
