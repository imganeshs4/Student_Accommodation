    ...
    <div>
      ...
      <nav>
        <ul class="menu">
          ...
          <li class="current"><a href="renting.html">Renting</a></li>
  ...
  <!--==============================content================================-->
   <section id="content">
    <div class="container_12">
      <div class="grid_8">
        <h2 class="top-1 p3">Room Details</h2>
        
        <form method="post" enctype="multipart/form-data">
          <table cellpadding="20" cellspacing="20" width="1000px" height="200px"  style="margin:auto" >
        <tr style="background-color:bisque" align="left" class="bold">            
             <td class="bold" style="color:black"  >Room No</td><td align="left" class="bold" style="color:black" >Rent</td><td align="left" class="bold" style="color:black" >Flat No</td>
...
$s="select * from room";
  ...
  {
        echo"<tr><td  style=' padding-left:50px'>$data[0]</td><td  style=' padding-left:10px'>$data[1]</td><td  style=' padding-left:20px'>$data[2]</td></td></tr>";
      }
      mysqli_close($cn);
?>
      </table>
